...
#intervalos que sacamos de cada caja. 
  ...
  #se muestran las tres ventanas al usuario
    ...
    if k == 27:
        break
    #al teclear 5 o que el video se termine, 
    
cv2.destroyAllWindows()

#se destruyen todas las ventanas y acaba el programa.
